...
export default function CrearHabilitacionPage() {
  ...
  const handlePersonaCompleta = (rol: 'titular' | 'conductor' | 'celador', persona: PersonaData) => {
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    onClick={() => setHabilitacion(prev => ({ ...prev, tipo_transporte: 'Escolar' }))}
        ...
        return (
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
            ...
            <p className="text-gray-600 mb-4">
              Formulario de vehículo (por implementar)
            </p>
            <div className="flex gap-3">
              <Button variant="outline" onClick={() => setPaso(4)}>
                Anterior
              </Button>
              <Button onClick={() => setPaso(6)}>
                Continuar
              </Button>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              {habilitacion.titular && (
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p>{habilitacion.titular.nombre} {habilitacion.titular.apellido}</p>
              ...
              {habilitacion.conductor && (
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-2">🚗 Conductor</h3>
                  <p>{habilitacion.conductor.nombre} {habilitacion.conductor.apellido}</p>
              ...
              {habilitacion.celador && (
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-2">👥 Celador</h3>
                  <p>{habilitacion.celador.nombre} {habilitacion.celador.apellido}</p>
                ...
                <div key={pasoInfo.numero} className="flex items-center">
                  ...
                  <div className="ml-3 hidden sm:block">
                    <p className={`text-sm font-medium ${
                      esActual ? 'text-blue-600' : esCompletado ? 'text-green-600' : 'text-gray-500'
                    }`}>
                      Paso {pasoInfo.numero}
                    </p>
                    <p className={`text-xs ${
                      esActual ? 'text-blue-500' : esCompletado ? 'text-green-500' : 'text-gray-400'
                    }`}>
                      {pasoInfo.titulo}
                    </p>
                  </div>
