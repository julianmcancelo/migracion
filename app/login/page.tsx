          ...
          <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 to-transparent p-12 flex flex-col justify-between text-white">
            <div className="animate-fade-in-down">
              ...
              <p className="text-xl opacity-90 text-shadow-sm">
                Una herramienta para optimizar el trabajo diario en el Municipio de Lanús.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  >
                    {!showPassword ? (
                      ...
                      <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21M12 15a3 3 0 11-6 0 3 3 0 016 0z" />
                      </svg>
                    )}
                  </button>
                </div>
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="recordarme" className="ml-2 text-gray-600 select-none">
                    Recordarme
                  </label>
                </div>
                <a href="#" className="font-semibold text-sky-600 hover:text-sky-700 transition duration-300">
